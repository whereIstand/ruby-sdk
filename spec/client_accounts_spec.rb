...
describe WIS::Client::Accounts do
	...
	it "account find by id should work" do
	...
	it "account find by id array should work" do
	...
	it "account find by name should work" do
	...
	it "account find by name array should work" do
